...
//        user1.setFid("user1-fid");
//        user2 = new User();
//        user2.setId("user2-id");
//        user2.setFid("user2-fid");
//        mongoTemplate.insertAll(List.of(user1, user2));
//
//        // Insert test data into the in-memory MongoDB
//        workout1 = new Workout("workout1-id", "Morning Workout", Arrays.asList(MuscleGroup.ABS, MuscleGroup.CHEST));
//        workout1.user = user1;
//        workout1.active = true;
//        workout1.startDateTime = LocalDateTime.now();
//
//        workout2 = new Workout("workout2-id", "Evening Workout", Arrays.asList(MuscleGroup.BACK_SHOULDERS, MuscleGroup.BICEPS));
//        workout2.user = user1;
//        workout2.active = false;
//        workout2.startDateTime = LocalDateTime.now();
//
//        workout3 = new Workout("workout3-id", "Afternoon Workout", Arrays.asList(MuscleGroup.TRICEPS, MuscleGroup.QUADS));
//        workout3.user = user2;
...
//        mongoTemplate.remove(workout1);
//        mongoTemplate.remove(workout2);
//        mongoTemplate.remove(workout3);
//    }
//
//    @Test
