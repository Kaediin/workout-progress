...
//
//    private ExerciseLog mockLog1, mockLog2, mockLog3;
//
//    @BeforeEach
//    void setUp() {
...
//        mockLog1 = new ExerciseLog(null, user1, workout1, exercise1);
//        mockLog1.id = "ExerciseLog-1";
//        mockLog1.logDateTime = LocalDateTime.now().minusDays(3);
//
//        // Second log aka middle
//        mockLog2 = new ExerciseLog(null, user1, workout1, exercise2);
//        mockLog2.id = "ExerciseLog-2";
//        mockLog2.logDateTime = LocalDateTime.now().minusDays(2);
//
//        // Third log aka youngest
//        mockLog3 = new ExerciseLog(null, user2, workout2, exercise1);
//        mockLog3.id = "ExerciseLog-3";
//        mockLog3.logDateTime = LocalDateTime.now().minusDays(1);
//        mongoTemplate.insertAll(List.of(mockLog1, mockLog2, mockLog3));
//    }
//
//    @AfterEach
//    void cleanUp() {
//        mongoTemplate.remove(mockLog1);
//        mongoTemplate.remove(mockLog2);
//        mongoTemplate.remove(mockLog3);
//    }
//
//    @Test
